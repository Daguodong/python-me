...
class Car():
    ...
    def read_odometer(self):
        print('this car  has '+str(self.odmeter_reading)+self.model)
...
class ElecticCar(Car):  #继承
    ...
    def __init__(self,make,model,year):
        ...
        self.battery=Battery(500)     #将实用作属性，注意由第31句知：battery=Battery()，然后:self.battery=battery
